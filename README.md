...
🛡️ Лицензия: [NC-License — некоммерческое использование](./LICENSE)
...
Баги
был найден баг мной при уже существуещем блокноте студентов посл добавки студентов n кол-во и сортировки их и сохраненпя в тот файл происходят странные вещи в чем проблема нашел fix ждите 1-2 дня
